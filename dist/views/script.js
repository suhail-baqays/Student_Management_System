...
addEventListener("DOMContentLoaded", () => {
    const Add_Modal = document.querySelector("#Add_Student_Modal");
    const Open_Add_Modal_btn = document.querySelector("#Open_Add_Modal_btn");
    const close_btn = document.querySelector("#close_btn");
    const nameInput = Add_Modal.querySelector('input[name="Name"]');
    const ageInput = Add_Modal.querySelector('input[name="Age"]');
    const Submit_Added_std_btn = Add_Modal.querySelector("#Submit_Added_std");
    ...
    function Validate_Inputs() {
        ...
        let ageValue = ageInput.valueAsNumber;
    ...
    Submit_Added_std_btn.disabled = true;
    const Shared_Update_Modal = document.querySelector("#Shared_Update_Modal");
    const close_update_btn = document.querySelector("#close_update_btn");
    const Submit_Updated_std = document.querySelector("#Submit_Updated_std");
    const form = document.querySelector("#Shared_Update_Form");
    const Input_Name = document.querySelector("#update_name_input");
    const Input_Age = document.querySelector("#update_age_input");
